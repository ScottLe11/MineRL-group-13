...
from .crafting_guide import (
    ...
    craft_wooden_axe, craft_pipeline_make_and_equip_axe, craft_table_then_axe,
)

__all__ = [
    "GuiClicker", "LOG_ITEM_KEYS", "PLANK_ITEM_KEYS", "STICK_ITEM_KEYS", "TABLE_ITEM_KEYS", "AXE_ITEM_KEYS", 
    "LOGICAL_TO_KEYS", "get_basic_inventory_counts", "close_table_gui_if_open", "craft_table_then_axe",
